      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        ...
        <form autoComplete="off" onSubmit={(e) => e.preventDefault()} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="name" name="plant-name" autoComplete="off" value={name} onChange={(e) => setName(e.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="species">Art</Label>
            <Input id="species" name="plant-species" autoComplete="off" value={species} onChange={(e) => setSpecies(e.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="room">Rum / placering</Label>
            <Input id="room" name="plant-room" autoComplete="off" value={room} onChange={(e) => setRoom(e.target.value)} />
          </div>
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              ...
              <Input id="light" name="plant-light" autoComplete="off" value={lightNeeds} onChange={(e) => setLightNeeds(e.target.value)} />
            </div>
          </div>
          <div className="space-y-2">
